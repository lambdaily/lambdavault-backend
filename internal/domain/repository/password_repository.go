...
type PasswordRepository interface {
	...
	FindByIDAndGroupID(ctx context.Context, id, groupID uuid.UUID) (*entity.Password, error)
	...
	ShareWithGroup(ctx context.Context, passwordID, groupID, sharedByID uuid.UUID) error
	UnshareFromGroup(ctx context.Context, passwordID, groupID uuid.UUID) error
